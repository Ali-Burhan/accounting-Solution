...
const Homereturninvoicedetail = () => {
	...
	},[selectedreturnedinvoices.length])
    ...
    <div class="row " >
        <div class="col-sm-12">
            ...
            <div className="row my-1">
                ...
                <h5 class="pull-right"> {supplierreturninvoice.length > 0? supplierreturninvoice.map((ele)=>(ids==ele.supplierinvoiceid?ele.returninvoicetitle:"")):""} </h5>
                </div>
				</div>
				...
				<div className="col-sm-4  text-center">
					...
					<address className='date' style={{fontSize:'25px'}} >
    					<strong >Date: </strong>
    					{supplierreturninvoice.length>0? returninvoicedetail.length > 0? supplierreturninvoice.map((row)=>(row.supplierreturninvoiceid == returninvoicedetail[0].supplierreturninvoiceid?row.returndate.slice(0,10):"")):"":""}
    				</address>
				</div>
    		</div>
            </div>
    		...
    		<div class="row" >
    			<div class="col-sm-9 ">
    				...
    				<b>Name:</b>	{supplier.length>0? supplier.map((ele)=>(returninvoicedetail.length>0? ele.supplierid==returninvoicedetail[0].supplierid?ele.suppliername:"":"")) :""}<br/>
    				<b>Address:</b>	{supplier.length>0? supplier.map((ele)=>(returninvoicedetail.length>0? ele.supplierid==returninvoicedetail[0].supplierid?ele.supplieraddress:"":"")) :""}<br/>
    				<b>Contact:</b>	{supplier.length>0? supplier.map((ele)=>(returninvoicedetail.length>0? ele.supplierid==returninvoicedetail[0].supplierid?ele.suppliercontact:"":"")) :""}
...
export default Homereturninvoicedetail