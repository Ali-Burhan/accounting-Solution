...
const Paypendingreturn = () => {
    ...
    const handleremaininginvoice = async () => {
        let headersList = {
           ...
           let response = await fetch(`/getselectedreturnremaining/${ids}`, { 
             method: "GET",
             headers: headersList
           });
    ...
    const handlepayment = async () => {
        ...
        const response = await fetch(`/addremainingreturnpayment/${invoices[0].supplierreturnremaininginvoice}`,{
            headers:{
                'Content-Type':'application/json'
            },
            method:'POST',
...
export default Paypendingreturn