              ...
              <TableBody>
                {
                  returninvoice.map((row) => ( 
                    ...
                    onClick={()=>navigate(`/returnsaleinvoicedetail/${row.customerinvoiceid}`)}
                    key={row.customerreturninvoiceid}
...
export default Homesalereturninvoice