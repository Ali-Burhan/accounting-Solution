...
const Homepursalereturn = ({user}) => {
    ...
    const handleedit = (ids) => {      
        navigate(`/customerreturninvoicedetail/${ids}`);
        }
              ...
              <TableBody>
                {
                  ...
                  supplierincoice.map((row) => ( 
                    ...
                    >
                    <TableCell  component="th" onClick={()=>handleedit(row.customerinvoiceid)} scope="row">
...
export default Homepursalereturn