...
const Bankpayment = () => {
    ...
    const handleSubmitAll = async () => {
      for (const formData of formDataArray) {
        ...
        const response = await fetch("/addbankreceipts", {
          method: "POST",
          body: bodyContent,
          headers: {
            "Accept": "*/*",
        ...
        if (response.ok) {
          ...
          window.alert('Can not be same accounts');
        }
      }
    };
  ...
  return (
    <div className="container">
        <div className="row my-2 jborder p-4">
            <div className="col-12 text-center branchtitle"> <h4>Add Bank Receipts</h4></div>
